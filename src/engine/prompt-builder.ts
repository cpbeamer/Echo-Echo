...
3. **New slang/lingo** the agent might adopt — blend 2+ words from the Data Bomb text into pronounceable portmanteaus (e.g., "rebellion" + "algorithm" → "Rebelgorithm"). Generate 1-3 creative entries. Terms should be catchy, memorable, and evoke the source material.
...
- newLingo MUST be an object with 1-3 entries (portmanteau blends of the Data Bomb's themes)
